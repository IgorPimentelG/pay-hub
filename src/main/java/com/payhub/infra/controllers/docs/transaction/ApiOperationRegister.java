...
@ApiResponses({
	@ApiResponse(responseCode = "200", description = "The transaction has been register", content = @Content(
		schema = @Schema(implementation = Transaction.class)
	)),
	@ApiResponse(responseCode = "400", description = "The transaction failed", content = @Content(
