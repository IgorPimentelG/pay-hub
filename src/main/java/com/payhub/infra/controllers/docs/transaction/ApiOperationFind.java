...
@ApiResponses({
	@ApiResponse(responseCode = "200", description = "The transaction was found", content = @Content(
		schema = @Schema(implementation = Transaction.class)
	)),
	@ApiResponse(responseCode = "404", description = "The transaction was not found", content = @Content(
